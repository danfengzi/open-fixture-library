...
const data = Object.keys(register.filesystem).map(key => {
  const [manKey, fixKey] = key.split(`/`);
  const fixture = model.fixtureFromRepository(manKey, fixKey);
...
writeFileSync(`fixture-graph.svg`, d3n.svgString(), `utf8`);
